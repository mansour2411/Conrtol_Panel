...
$database = "CREATE DATABASE IF NOT EXISTS CONTROLPANEL";

# Connect datebase to the server
...
$users = "CREATE TABLE IF NOT EXISTS USERS(
    ...
    JOB ENUM('STUDENT','LECTURE') NOT NULL,
    DISCRIPTION VARCHAR(100) NOT NULL,
    PRIMARY KEY(EMAIL)
)";

# Create COURSES Table 
$course = "CREATE TABLE IF NOT EXISTS COURSES (
    COURSEID INT(6) AUTO_INCREMENT,
    COURSENAME VARCHAR(20) NOT NULL,
    MAJOR VARCHAR(20) NOT NULL,
    LECTURE_NAME VARCHAR(20) NOT NULL,
    DURATION VARCHAR(20) NOT NULL,
    NUMBEROFVIDEO INT(20) NOT NULL,
    AVAILABLESTUDENT INT(6) NOT NULL,
    COURSETYPE ENUM('ONLINE', 'RECORD') NOT NULL,
...
# يجب تشغيل هذا الكود على phpmyadmin 
# كي يقوم بإحضار  الدول إلى القائمة 
# لا أعرف ما هي مشكلة الكود في التنفيد
/*  
...
";
*/
# Connect USERS Table To Database
$res_user = mysqli_query($conn, $users);

# Connect COURSES Table To Database
$res_course = mysqli_query($conn, $course);

# Connect COUNTRY TABLE TO Database
$res_country = mysqli_query($conn, $country);
