...
-->
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
          <div class="kt-container kt-container--fluid">
            <div class="kt-subheader__main">
              <h3 class="kt-subheader__title">Courses</h3>
            </div>
          </div>
        </div>
        ...
        <!-- begin:: My Content -->
        <?php
        $course_name = $major = $lecture_name = $course_duration = $number_of_video = $available_student = $type = $price = NULL;
        $errors = array(
          'course_name' => NULL,
          'major' => NULL,
          'lecture_name' => NULL,
          'course_duration' => NULL,
          'number_of_video' => NULL,
        ...
        if (isset($_POST['submit'])) {
          $course_name = cleanData($_POST['coursename']);
          $major = cleanData($_POST['major']);
          $lecture_name = cleanData($_POST['lecture_name']);
          $course_duration = cleanData($_POST['course_duration']);
          $number_of_video = cleanData($_POST['video_number']);
          $available_student = cleanData($_POST['student_available']);
          $type = cleanData($_POST['course_type']);
          $price = cleanData($_POST['course_price']);


          if (empty($course_name)) {
            $errors['course_name'] = "Add Course Name";
          } else if (preg_match('/^[^0-9]*$/', $course_name) == FALSE) {
            $errors['course_name'] = "Enter A character only";
          }
          ...
          if (empty($lecture_name)) {
            $errors['lecture_name'] = "Enter lecture name";
          } else if (preg_match('/^[^0-9]*$/', $lecture_name) == FALSE) {
            $errors['lecture_name'] = "Just Character";
          }


          if (empty($course_duration)) {
            $errors['course_duration'] = "Enter course duration";
          } else if (preg_match('/[1-9][0-9]*|0$/', $course_duration) == FALSE) {
            $errors['course_duration'] = "Enter an invalid duration";
          }

          if (empty($number_of_video)) {
            $errors['number_of_video'] = "Positive Number ";
          } else if (preg_match('/[1-9][0-9]*|0$/', $number_of_video) == FALSE) {
            $errors['number_of_video'] = "Enter an invalid Number";
          }

          if (empty($available_student)) {
            $errors['available_student'] = "Enter Available Student";
          } else if (preg_match('/[1-9][0-9]*|0$/', $number_of_video) == FALSE) {
            $errors['available_student'] = "Enter an invalid Number";
          }

          if (empty($type)) {
            $errors['type'] = "Select The Type Of Course";
          }

          if (empty($price)) {
            $errors['price'] = "Enter a Price";
          } else if (preg_match('/[1-9][0-9]*|0$/', $price) == FALSE) {
            $errors['price'] = "Positive Integer Value";
          }
        }
        ?>
          ...
          <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
            <div class="kt-portlet__head">
              <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">Add Course</h3>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="major" id="" />
                        <?= $errors['major'] ?>
                      </div>
                    </div>
                    <!-- End col -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="lecture_name" id="" />
                        <?= $errors['lecture_name'] ?>
                      </div>
                    </div>
                    <!-- End col -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="course_duration" id="" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Number of Video: </label>
                        <input class="form-control" type="text" name="video_number" id="" />
                        <?= $errors['number_of_video'] ?>
                      </div>
                    </div>
                    <!-- End col -->
                    <!-- Start col -->
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Available Student: </label>
                        <input class="form-control" type="text" name="student_available" id="" />
                        <?= $errors['available_student'] ?>
                      </div>
                    </div>
                    <!-- End col -->
                    <!-- Start col -->
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label class="col-form-label col-lg-3 col-sm-12">Course Type</label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                          <select class="form-control kt-select2" id="kt_select2_10" name="course_type">
                            <option></option>
                    ...
                    <div class="col-md-6">
                      <div class="form-group position-relative">
                        <label for="">Courses Price: </label>
                        <input class="form-control" type="text" name="course_price" id="" />
                        <span style="
                              position: absolute;
                              top: 50%;
                              right: 1%;
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        if (array_filter($errors) == []) {
                          $insertData = "INSERT INTO COURSES(COURSENAME, MAJOR, LECTURE_NAME, DURATION, NUMBEROFVIDEO, AVAILABLESTUDENT, COURSETYPE, PRICE) VALUES('$course_name','$major','$lecture_name', '$course_duration', '$number_of_video', '$available_student', '$type', '$price')";
          ...
          <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
              <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">All Courses</h3>
              </div>
            </div>
            <div class="kt-portlet__body">
              <!--begin: Datatable -->
